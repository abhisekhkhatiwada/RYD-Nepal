...
const About: React.FC = () => {
  useSEO({
    title: 'About RYD Nepal — Kathmandu\'s #1 Bike Rental for Gig Workers | Pathao, InDrive, Yango & Tootle Riders',
    ...
    keywords: 'about RYD Nepal, RYD Nepal company, bike rental company Kathmandu, motorcycle rental company Nepal, gig economy Nepal, Pathao partner Nepal, InDrive partner Kathmandu, Yango partner Nepal, who is RYD Nepal, Abhishek Khatiwada RYD, motorcycle rental startup Nepal, best bike rental Kathmandu, आरवाईडी नेपाल बारेमा',
    path: '/about',
    jsonLd: [
      breadcrumbJsonLd([
  ...
  return (
    <div className="animate-in fade-in duration-700">
      <Helmet>
        <title>About RYD Nepal — Kathmandu's Largest Bike Rental Fleet</title>
        <meta name="description" content="RYD Nepal Pvt. Ltd. empowers gig workers in Kathmandu with affordable Hero Super Splendor 125cc motorcycle rentals. 500+ active riders, dedicated Kapan workshop, rent-to-own program." />
        <link rel="canonical" href="https://www.rydnepal.com/about" />
      </Helmet>
      {/* Header */}
      <section className="py-20 bg-slate-50 border-b border-slate-100">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-lg text-slate-600 max-w-3xl mx-auto leading-relaxed">
            RYD Nepal was founded on a simple realization: many hardworking people in Kathmandu want to earn through ride-sharing and delivery on <strong>Pathao, InDrive, Yango, and Tootle</strong> but lack the capital to buy their own motorcycle.
          </p>
        </div>
      </section>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12">
            <div className="bg-slate-800 p-6 sm:p-10 rounded-3xl border border-slate-700">
              ...
              <p className="text-slate-400 leading-relaxed">
                To provide inclusive and affordable motorcycle rental solutions in Kathmandu that enable every hardworking Nepali to participate in the growing gig economy — earning on Pathao, InDrive, Yango, Tootle, and food delivery platforms without the financial stress of buying a bike.
              </p>
            </div>
            <div className="bg-slate-800 p-6 sm:p-10 rounded-3xl border border-slate-700">
              <div className="bg-primary w-14 h-14 rounded-2xl flex items-center justify-center mb-8 shadow-lg shadow-primary-500/20">
              ...
              {[
                {
                  ...
                  desc: 'Launched with a fleet of 50 Hero Super Splendor 125cc motorcycles in Kathmandu under President Abhishek Khatiwada, targeting Pathao, InDrive, Yango, and Tootle riders who need affordable bike rental.',
      ...
      <section className="py-16 bg-primary-50 border-t border-primary-100" aria-label="Apply for bike rental">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="text-slate-600 mb-8">Join 500+ riders who trust RYD Nepal. Rent a Hero Super Splendor 125cc from Rs. 700/day and start earning on Pathao, InDrive, Yango, or Tootle today.</p>
